...
//volatile __attribute__((aligned(16))) uint8_t ltdc_framebuffer[800 * 480 * 2]; //FIXME A remettre si on veut que ca fonctionne
/* USER CODE END PV */
...
static void MX_LTDC_Init(void)
{
  ...
  //FIXME A remettre si on veut que ca fonctionne
